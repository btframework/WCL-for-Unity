...
public class BluetoothErrors
{
    ...
    public const Int32 WCL_E_BLUETOOTH_CREATE_ADAPTER_STATICS_FAILED = WCL_E_BLUETOOTH_BASE + 0x0077;
    public const Int32 WCL_E_BLUETOOTH_CREATE_ADAPTER_FAILED = WCL_E_BLUETOOTH_BASE + 0x0078;
    public const Int32 WCL_E_BLUETOOTH_UNABLE_CHANGE_RADIO_STATE = WCL_E_BLUETOOTH_BASE + 0x0079;
    public const Int32 WCL_E_BLUETOOTH_UNABLE_RADIO_STATE_THREAD = WCL_E_BLUETOOTH_BASE + 0x007A;
    public const Int32 WCL_E_BLUETOOTH_GET_RADIO_STATE_CHANGE_RESULT = WCL_E_BLUETOOTH_BASE + 0x007B;
    public const Int32 WCL_E_BLUETOOTH_INCOMPATIBLE_OS_BITS = WCL_E_BLUETOOTH_BASE + 0x007C;
    public const Int32 WCL_E_BLUETOOTH_START_GET_DEV_TYPE_THREAD_FAILED = WCL_E_BLUETOOTH_BASE + 0x007D;
    public const Int32 WCL_E_BLUETOOTH_GET_DEV_TYPE_THREAD_GET_RESULT_FAILED = WCL_E_BLUETOOTH_BASE + 0x007E;
    public const Int32 WCL_E_BLUETOOTH_START_GET_DEV_NAME_THREAD_FAILED = WCL_E_BLUETOOTH_BASE + 0x007F;
    public const Int32 WCL_E_BLUETOOTH_GET_DEV_NAME_THREAD_GET_RESULT_FAILED = WCL_E_BLUETOOTH_BASE + 0x0080;
    public const Int32 WCL_E_BLUETOOTH_NO_SYSTEM_RESOURCES = WCL_E_BLUETOOTH_BASE + 0x0081;
    public const Int32 WCL_E_BLUETOOTH_GET_BLUETOOTH_RADIO_ASYNC_FAILED = WCL_E_BLUETOOTH_BASE + 0x0082;
    public const Int32 WCL_E_BLUETOOTH_BLUETOOTH_RADIO_INSTANCE_NOT_READY = WCL_E_BLUETOOTH_BASE + 0x0083;
    public const Int32 WCL_E_BLUETOOTH_CREATE_REG_CHANGE_TERMINATION_EVENT_FAILED = WCL_E_BLUETOOTH_BASE + 0x0084;
    public const Int32 WCL_E_BLUETOOTH_CREATE_REG_CHANGE_RESULT_EVENT_FAILED = WCL_E_BLUETOOTH_BASE + 0x0085;
    public const Int32 WCL_E_BLUETOOTH_START_REG_CHANGE_THREAD_FAILED = WCL_E_BLUETOOTH_BASE + 0x0086;
    public const Int32 WCL_E_BLUETOOTH_REGISTER_AUTHENTICATION_CALLBACK_FAILED = WCL_E_BLUETOOTH_BASE + 0x0087;
    public const Int32 WCL_E_BLUETOOTH_FAILED_TO_OPEN_AUTH_AGENT_REG_KEY = WCL_E_BLUETOOTH_BASE + 0x0088;
    public const Int32 WCL_E_BLUETOOTH_CREATE_REG_CHANGES_NOTIFICATION_EVENT_FAILED = WCL_E_BLUETOOTH_BASE + 0x0089;
    public const Int32 WCL_E_BLUETOOTH_UNABLE_SET_REGISTRY_CHANGES_NOTIFICATIONS = WCL_E_BLUETOOTH_BASE + 0x008A;
    public const Int32 WCL_E_BLUETOOTH_UNABLE_TO_DISABLE_AUTHENTICATION_AGENT = WCL_E_BLUETOOTH_BASE + 0x008B;
    public const Int32 WCL_E_BLUETOOTH_PAIRED_BY_OTHER = WCL_E_BLUETOOTH_BASE + 0x008C;
...
public class GattClient : BluetoothImports
{
    ...
    private static extern Int32 GattClientReadCharacteristicValue(
        [param: MarshalAs(UnmanagedType.SysInt), In] IntPtr Client,
        [param: In] ref GattCharacteristic Char,
        [param: MarshalAs(UnmanagedType.SysInt), Out] out IntPtr ppValue,
        [param: MarshalAs(UnmanagedType.U4), Out] out UInt32 pSize);
    ...
    public Int32 ReadValue(GattCharacteristic Char, out Byte[] Value)
    {
        ...
        IntPtr ppValue;
        UInt32 pSize;
        Int32 Result = GattClientReadCharacteristicValue(FClient, ref Char, out ppValue, out pSize);
...
public class GattClientDemo : MonoBehaviour
{
    ...
    private void FManager_OnDiscoveringStarted(System.Object sender, IntPtr Radio)
    {
